...
const Table = ({ openColumn, setOpenColumn, sortConfig, setSortConfig, currentTasks, filters, setFilters }) => {
  ...
  const Dropdown = ({ column }) => (
    <div className="absolute mt-1 w-40 bg-white dark:bg-gray-800 shadow-md rounded-md text-xs z-50">
      <ul>
        {["contains","not_contains","starts_with","ends_with","equals","not_equals","reset"].map((opt) => (
          <li
            key={opt}
      ...
      <table className="w-full text-sm text-left bg-white dark:bg-gray-800 transition-colors duration-300">
        ...
        <thead className="dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs">
          <tr>
            ...
            <th className="px-4 py-3 border-b border-gray-300 dark:border-gray-600 uppercase">Subject</th>
            <th className="px-4 py-3 border-b border-gray-300 dark:border-gray-600 uppercase">Status</th>
            <th className="px-4 py-3 border-b border-gray-300 dark:border-gray-600 uppercase">Priority</th>
            <th className="px-8 py-3 border-b border-gray-300 dark:border-gray-600 uppercase">Assigned to</th>
            <th className="px-4 py-3 border-b border-gray-300 dark:border-gray-600 uppercase">Start date</th>
            <th className="px-4 py-3 border-b border-gray-300 dark:border-gray-600 uppercase">Due Date</th>
            <th className="px-4 py-3 border-b border-gray-300 dark:border-gray-600 uppercase">Priority</th>
            <th className="px-4 py-3 border-b border-gray-300 dark:border-gray-600 uppercase">Completion</th>
          </tr>

          
          <tr>
            <td className="px-2 py-2 border-b border-gray-300 dark:border-gray-600">{renderFilterInput("id")}</td>
            <td className="px-4 py-2 border-b border-gray-300 dark:border-gray-600">{renderFilterInput("subject")}</td>
            <td className="px-4 py-2 border-b border-gray-300 dark:border-gray-600">{renderFilterInput("status")}</td>
            ...
            <td className="px-8 py-2 border-b border-gray-300 dark:border-gray-600">{renderFilterInput("assignedTo")}</td>
            ...
            <td className="py-2 border-b border-gray-300 dark:border-gray-600">
              <div className="flex items-center gap-1">
                ...
                <DatePicker
                  ...
                  className="w-20 px-2 py-1 rounded dark:border-gray-600 
                             bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 
                             focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
            ...
            <td className="px-4 py-2 border-b border-gray-300 dark:border-gray-600">{renderFilterInput("dueDate")}</td>
            <td className="px-4 py-2 border-b border-gray-300 dark:border-gray-600">{renderFilterInput("priority")}</td>
          </tr>
        </thead>
